...
!=======================================================================
   ...
   !Print "(f6.3)", avrSWAP(48)
   !Print "(f6.3)", avrSWAP(37) !yaw angle (rad)
   !Yst = avrSWAP(37)-avrSWAP(24)
   !print *,'Yaw angle avrSWAP(37)'
   !Print "(f6.3)", avrSWAP(37)
   !print *,'Yaw rate avrSWAP(48)'
   !Print "(f6.3)", avrSWAP(48)
   !print *,'Yaw error avrSWAP(24)'
   !Print "(f6.3)", avrSWAP(24)
